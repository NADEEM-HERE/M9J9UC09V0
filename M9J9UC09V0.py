    ...
    for index, i in enumerate(ns):
        try:
            ...
            if s.ok:
                ...
                print (e.strftime("--> L3G3ND M9J9U D09 H3R3 :D | | Date :: %d-%m-%Y  TIME :: %I:%M:%S %p"))
...
print('''\033[1;33m-=[ 𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 𝐈𝐃 :: https://www.facebook.com/mdakhar.mdakhtar /]=-\n''')
i = datetime.now()
print('''\033[1;36m---------------------------------------------------------------------\n''')
print(i.strftime("\033[1;32m[#] Start Time ==> %Y-%m-%d %I:%M:%S %p "))
print('''\033[1;32m[#] _ Tool Fucker == > [ 𝐀𝐋𝐎𝐍𝐄 𝐒𝐓𝐀𝐍𝐃 𝐌𝐀𝐉𝐍𝐔 𝐃𝐎𝐍  ]\n''')
print("\033[1;36;40m", end = "")        
password = input("\033[1;36m[+] PASSWORD KE LIYE 9238511811 WSP MSG KAR   :: ")
